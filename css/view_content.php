    ...
    <div class="row">
        <nav class="menu nav">
			<div id="menu-list">
                <ul>
                    <hr>
                    <li><a href="meidicine.php#medications">Лекарства</a></li>
                    <hr>
                    <li><a href="meidicine.php#vitamin">Витамины</a></li>
                    <hr>
                    <li><a href="meidicine.php#gestation">Беременность</a></li>
					<hr>
                    <li><a href="meidicine.php#doppelherz">Doppelherz</a></li>
                    <hr>
                    <li><a href="meidicine.php#for_kids">Для детей</a></li>
                </ul>
                <div id="cart">
	        			...
	        			if($row["rus_title"]){
			        		echo'
			        			<div id="view_product">
				        			...
				        			<div>
				        				<div id="view_title">
					        				<strong>'.$row["ger_title"].'</strong><strong>('.$row["rus_title"].')</strong>
					        			</div>
					        			<hr>
